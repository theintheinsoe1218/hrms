<template>
  <v-container fluid>
    ...
    <v-row class="mt-6">
      <v-col cols="12">
        <v-card elevation="1" class="rounded-lg pa-6" min-height="300">
          <h3 class="text-h6 mb-4">Recent Transactions</h3>
          <p class="text-grey">Data table or charts will go here...</p>
        </v-card>
      </v-col>
    </v-row>
  </v-container>
